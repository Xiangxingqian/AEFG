...
public class Global {
	...
	private List<SootClass> allClasses = new ArrayList<SootClass>();
	...
	private List<Local> unReachingLocal = new ArrayList<Local>();
	...
	public static class ManifestInfo{
		public static Set<String> activities = null;
		public static Set<String> allActivities = null;
		public static Set<String> entrypoints = null;
